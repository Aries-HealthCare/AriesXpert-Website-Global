    ...
    <section className="relative w-full overflow-hidden bg-[#FAF9FF] dark:bg-[#0A0914] min-h-[calc(100vh-4rem)] lg:min-h-0 xl:min-h-[860px] flex flex-col justify-between transition-colors duration-500">
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 flex-1 flex flex-col justify-between py-4 sm:py-6 lg:py-8 xl:py-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-14 items-center flex-1 my-auto">
          ...
          <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center py-1 lg:py-0">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3 sm:mb-4 lg:mb-5">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs backdrop-blur-md">
              ...
              <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs backdrop-blur-md">
            ...
            {/* 4 Feature Icon Pills: 2 spacious columns for comfortable readability on all displays */}
            <div className="grid grid-cols-2 gap-2.5 sm:gap-3 lg:gap-3.5 mb-5 sm:mb-6 lg:mb-7">
              {/* Pill 1 */}
              <div className="flex items-center gap-2.5 sm:gap-3 p-2.5 sm:p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:shadow-md hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mb-5 sm:mb-6 lg:mb-7">
              <button
                ...
                className="h-11 sm:h-12 lg:h-13 px-6 sm:px-8 text-sm lg:text-base font-bold rounded-full bg-gradient-to-r from-[#6D28D9] via-[#8B5CF6] to-[#BE185D] hover:from-[#5B21B6] hover:via-[#7C3AED] hover:to-[#9D174D] text-white shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/35 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 border-none group cursor-pointer flex items-center justify-center gap-2.5 whitespace-nowrap"
              >
          ...
          <div className="lg:col-span-6 xl:col-span-6 h-full flex items-center justify-center relative pt-2 lg:pt-0">
            <div className="relative w-full max-w-[620px] lg:max-w-none">
              ...
              <div className="hidden sm:block absolute -top-4 -right-3 sm:-right-4 lg:-right-6 z-20 animate-float">
                <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-3 sm:p-3.5 shadow-xl shadow-purple-950/10 min-w-[145px] sm:min-w-[170px] space-y-2">
              ...
              <div className="hidden sm:block absolute bottom-4 sm:bottom-6 right-3 sm:right-6 lg:right-8 z-20 animate-float-delayed">
                <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-3 sm:p-3.5 shadow-xl shadow-purple-950/10 flex items-center gap-3">
        ...
        <div className="w-full shrink-0 pt-6 sm:pt-8 lg:pt-10 pb-1 sm:pb-2 lg:pb-3">
          <div className="w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-purple-100/90 dark:border-slate-800/80 rounded-2xl sm:rounded-3xl py-3.5 px-4 sm:py-4 sm:px-6 lg:py-4.5 lg:px-8 shadow-lg shadow-purple-950/5">
