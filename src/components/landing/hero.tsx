...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#FAF9FF] dark:bg-[#0A0914] min-h-[calc(100vh-5rem)] md:min-h-[calc(100vh-6rem)] flex flex-col justify-between transition-colors duration-500">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 max-w-7xl 2xl:max-w-[1720px] flex-1 flex flex-col justify-between py-2 sm:py-3 lg:py-4 relative z-10">
        
        {/* ──────── 2-Column Main Content Row ──────── */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 xl:gap-12 items-center flex-1 my-auto py-1 sm:py-2">
          ...
          <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center py-1 lg:py-0">
            ...
            <h1 className="font-headline text-2xl sm:text-3xl md:text-4xl lg:text-[40px] xl:text-[50px] 2xl:text-[54px] font-black text-slate-900 dark:text-white tracking-tight leading-[1.08] mb-2 sm:mb-2.5">
            ...
            {/* Subtitle */}
            <p className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-300 font-normal leading-relaxed max-w-lg mb-2.5 sm:mb-3.5">
              Expert physiotherapy and professional nursing care, now at your doorstep. Part of the trusted Aries clinical network.
            </p>

            {/* 4 Feature Icon Pills: 2 cols on mobile/tablet, 4 on xl */}
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4 gap-2 sm:gap-2.5 mb-3 sm:mb-4">
              {/* Pill 1 */}
              <div className="flex items-center gap-2 p-1.5 sm:p-2 rounded-xl bg-white/80 dark:bg-slate-900/70 border border-purple-100 dark:border-slate-800 shadow-xs hover:shadow-md hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="min-w-0 flex-1 text-[10px] sm:text-xs font-bold text-slate-800 dark:text-slate-200 leading-tight">
                  Home Visit<br className="inline sm:hidden lg:inline xl:hidden" /> Care
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-1.5 sm:p-2 rounded-xl bg-white/80 dark:bg-slate-900/70 border border-emerald-100 dark:border-slate-800 shadow-xs hover:shadow-md hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="min-w-0 flex-1 text-[10px] sm:text-xs font-bold text-slate-800 dark:text-slate-200 leading-tight">
                  Certified<br className="inline sm:hidden lg:inline xl:hidden" /> Professionals
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-1.5 sm:p-2 rounded-xl bg-white/80 dark:bg-slate-900/70 border border-amber-100 dark:border-slate-800 shadow-xs hover:shadow-md hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="min-w-0 flex-1 text-[10px] sm:text-xs font-bold text-slate-800 dark:text-slate-200 leading-tight">
                  Flexible<br className="inline sm:hidden lg:inline xl:hidden" /> Scheduling
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-1.5 sm:p-2 rounded-xl bg-white/80 dark:bg-slate-900/70 border border-blue-100 dark:border-slate-800 shadow-xs hover:shadow-md hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="min-w-0 flex-1 text-[10px] sm:text-xs font-bold text-slate-800 dark:text-slate-200 leading-tight">
                  Personalized<br className="inline sm:hidden lg:inline xl:hidden" /> Treatment
                </div>
              </div>
            </div>

            {/* Action Buttons */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-3 sm:mb-3.5">
              <BookAppointmentButton 
                size="lg" 
                className="h-10 sm:h-11 lg:h-11 px-6 sm:px-7 text-xs sm:text-sm md:text-base font-bold rounded-full bg-gradient-to-r from-[#6366F1] via-[#8B5CF6] to-[#BE185D] hover:from-[#4F46E5] hover:via-[#7C3AED] hover:to-[#9D174D] text-white shadow-md shadow-purple-500/25 hover:shadow-lg hover:shadow-purple-500/35 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 border-none group cursor-pointer"
              >
                Book Home Visit
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex items-center -space-x-2">
                {realTherapistAvatars.map((src, i) => (
                  <div 
                    key={i} 
                    className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full border-2 border-white dark:border-slate-900 overflow-hidden shadow-xs shrink-0"
                  >
                    <Image 
                      src={src} 
                ...
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border-2 border-white dark:border-slate-900 bg-amber-100 dark:bg-amber-950/90 text-amber-800 dark:text-amber-200 text-[10px] sm:text-[11px] font-bold flex items-center justify-center shadow-xs shrink-0">
                  2.5k+
                </div>
              </div>
          ...
          <div className="lg:col-span-6 xl:col-span-6 h-full flex items-center justify-center relative pt-1 lg:pt-0">
            <div className="relative w-full h-[280px] sm:h-[340px] md:h-[370px] lg:h-[clamp(320px,46vh,460px)] xl:h-[clamp(360px,50vh,520px)] max-w-[620px] lg:max-w-none">
              
              {/* Organic curved violet aura backdrop */}
              <div className="absolute -top-10 -left-10 w-[360px] h-[360px] sm:w-[440px] sm:h-[440px] rounded-full bg-gradient-to-tr from-purple-200/50 via-violet-100/40 to-transparent blur-2xl pointer-events-none" />
              <div className="absolute -bottom-8 -right-8 w-72 h-72 rounded-full bg-indigo-200/30 blur-2xl pointer-events-none" />

              {/* Expansive Clinical Photography Container */}
              <div className="relative w-full h-full rounded-[28px] sm:rounded-[36px] lg:rounded-[40px] overflow-hidden shadow-2xl shadow-purple-900/10 dark:shadow-purple-950/40 border border-white/90 dark:border-slate-800/80 bg-slate-100 dark:bg-slate-900 group">
                <Image
                  ...
                  className="object-cover object-[center_20%] lg:object-center scale-[1.01] group-hover:scale-105 transition-transform duration-1000 ease-out"
                />
              ...
              <div className="absolute -top-6 sm:-top-8 left-2 sm:-left-4 z-20 pointer-events-none">
                <div className="relative">
                  <span className="font-script text-xl sm:text-2xl md:text-3xl text-slate-800 dark:text-purple-200 font-bold tracking-wide transform -rotate-6 inline-block drop-shadow-sm select-none">
                    Healing<br />
                    Moves With You
                  </span>
                  <svg 
                    className="w-12 sm:w-14 h-6 sm:h-7 text-slate-600 dark:text-purple-300 stroke-current ml-5 -mt-1 opacity-80" 
                    viewBox="0 0 100 45" 
                    fill="none"
                  >
              ...
              <div className="absolute -top-2 sm:-top-3 -right-1 sm:-right-2 z-20 animate-float">
                <div className="bg-white/94 dark:bg-slate-900/94 backdrop-blur-xl border border-white/80 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-2.5 sm:p-3 shadow-lg shadow-purple-500/10 min-w-[145px] sm:min-w-[165px] space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] sm:text-xs font-semibold text-slate-800 dark:text-slate-200">
                      Reduce Pain
                    </span>
                  </div>
              ...
              <div className="absolute -bottom-2 sm:-bottom-3 right-2 sm:right-5 z-20 animate-float-delayed">
                <div className="bg-white/94 dark:bg-slate-900/94 backdrop-blur-xl border border-white/80 dark:border-slate-800 rounded-xl sm:rounded-2xl p-2 sm:p-2.5 shadow-lg shadow-purple-500/10 flex items-center gap-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-violet-100 dark:bg-violet-950/80 text-violet-600 dark:text-violet-300 flex items-center justify-center shrink-0">
                    <Home className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  </div>
                  <div>
        ...
        <div className="w-full shrink-0 pt-2 pb-1.5 sm:pb-2.5 lg:pb-3">
          <div className="w-full bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl border border-purple-100/90 dark:border-slate-800/80 rounded-2xl sm:rounded-3xl p-3 sm:py-3 sm:px-6 lg:py-3 lg:px-8 shadow-lg shadow-purple-900/5">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 items-center divide-y sm:divide-y-0 sm:divide-x divide-slate-100 dark:divide-slate-800/80">
              ...
              <div className="flex items-center justify-start sm:justify-center lg:justify-end gap-2.5 pt-2 sm:pt-0 sm:pl-6">
                <span className="font-script text-lg sm:text-xl md:text-2xl text-slate-800 dark:text-purple-200 font-bold">
                  Your Recovery Our Priority
                </span>
                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-pink-100 dark:bg-pink-950/80 text-pink-500 flex items-center justify-center shrink-0 animate-pulse">
                  <Heart className="w-3 h-3 sm:w-3.5 sm:h-3.5 fill-pink-500" />
                </div>
              </div>
